...
<template>
  <div class="w-full flex overflow-hidden bg-gray-50 dark:bg-gray-900" style="height: 100dvh;">
      ...
      <div class="min-h-0 flex flex-1 flex-col overflow-hidden">
        ...
        <div class="custom-scrollbar min-h-0 flex flex-1 flex-col overflow-y-auto overflow-x-hidden p-3 md:p-6 sm:p-4 md:pb-[calc(6.5rem+env(safe-area-inset-bottom))] sm:pb-[calc(6.5rem+env(safe-area-inset-bottom))] pb-[calc(6.5rem+env(safe-area-inset-bottom))]">
